...
/*   Updated: 2024/12/17 11:08:38 by tpipi            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// handle_movement.c
void			handle_forward_movement(t_data *data, t_player *player, \
				float speed);
void			handle_backward_movement(t_data *data, t_player *player, \
				float speed);
void			handle_side_movement(t_data *data, t_player *player, \
...
void			draw_simple_wall(t_data *data, int x, int wall_start, \
				int wall_end);
