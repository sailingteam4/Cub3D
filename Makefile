...
SRC_WINDOW = $(addprefix src/Cub3D/window/, mlx_make.c keybinds.c mlx_utils.c draw_screen.c handle_movement.c)
SRC_RAYCASTING = $(addprefix src/Cub3D/raycasting/, draw_3d.c rc_utils.c)
SRC = $(SRC_PARSING) $(SRC_WINDOW) $(SRC_RAYCASTING)

SRC_BONUS_WINDOW = $(addprefix src/Cub3D/window/, mlx_make.c keybinds_bonus.c mlx_utils.c draw_screen_bonus.c handle_movement.c draw_player_bonus.c)
